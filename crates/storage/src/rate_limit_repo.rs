...
//! `RateLimitService` impl. The `DragonflyDB`-backed impl in
//! the auth crate is the production path; this storage is the
//! "small deploys without Redis" fallback documented in the
