    ...
    json!({
        ...
        "properties": {
            "parts": {
                ...
                "properties": {
                    "county": part_field("縣 / 市 in post-改制 canonical form."),
                    "district": part_field("鄉 / 鎮 / 市 / 區."),
                    "road": part_field("路 / 街 / 道 including the trailing suffix character."),
                    "section": part_field("段 — Arabic or Chinese numeral."),
                    "lane": part_field("巷."),
                    "alley": part_field("弄."),
                    "number": part_field("號 — supports `123`, `123-1`, `123之5`."),
                    "floor": part_field("樓 / F / B<n>F."),
                },
                "additionalProperties": false,
            },
            "normalized": {
